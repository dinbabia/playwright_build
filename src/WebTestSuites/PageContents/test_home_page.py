...
def test_homepage_select_multiple_options(page: Page) -> None:
    ...
    pen_checkbox = page.locator("input[name=\"accessories\"]").first
    ...
    bag_checkbox = page.locator("input[name=\"accessories\"]").nth(3)
...
def test_homepage_ordered_unordered_lists(page : Page) -> None:
    ...
    step.navigate_to_homepage(page)
    # Check Ordered List
    ordered_list = page.locator("xpath=//div[@id='HTML25']/div/ol/li")
    ...
    unordered_list = page.locator("xpath=//div[@id='HTML26']/div/ul/li")
...
def test_homepage_table(page : Page) -> None:
    ...
    headers = page.locator("xpath=//table[@id='table1']/thead/tr/th").all_inner_texts()
    # Check row one
    row_one = page.locator("xpath=//table[@id='table1']/tbody/tr[1]/td").all_inner_texts()
    check.check_element_texts_dict(headers=headers,
        actual_list=row_one, expected=TABLE_CONTENTS.data[0])
    # Check row two
    row_two = page.locator("xpath=//table[@id='table1']/tbody/tr[2]/td").all_inner_texts()
    check.check_element_texts_dict(headers=headers,
        actual_list=row_two, expected=TABLE_CONTENTS.data[1])
    # Check row three
    row_three = page.locator("xpath=//table[@id='table1']/tbody/tr[3]/td").all_inner_texts()
    check.check_element_texts_dict(headers=headers,
        actual_list=row_three, expected=TABLE_CONTENTS.data[2])
    # Check row four
    row_four = page.locator("xpath=//table[@id='table1']/tbody/tr[4]/td").all_inner_texts()
    check.check_element_texts_dict(headers=headers,
